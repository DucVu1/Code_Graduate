def fpc_compress(words):
    ...
    compressed_data = []
    prefix_list = []
    original_size = len(words) * 32  # Each word is 32 bits
    compressed_size = 0
    ...
    while i < len(words):
        ...
        # Pattern 111: Uncompressed word
            ...
            compressed_size += 3 + 32
        
        i += 1
    
    return prefix_list, compressed_data, original_size, compressed_size


# Example usage:
test_words = [0, 0, 0, 5, 128, 32768, 0x00FF00FF, 42, 0, 0]
prefixes, compressed, original_size, compressed_size = fpc_compress(test_words)

# Display results
print("Original Data:", test_words)
